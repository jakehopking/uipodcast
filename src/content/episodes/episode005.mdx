...
format: QuickCuppa
path: /episodes/5
podcastUrl: https://www.buzzsprout.com/1180283/4590401-quickcuppa-thoughts-on-gatsbyjs-the-react-based-ssg-framework.mp3
tags:
  [
    'development',
    'solo',
...
I this week's episode I share my thoughts on the use of GatsbyJS and whether I feel it's a viable static site generator framework.

### Overview

- Talk about static sites and generators
- Cover basics of GatsbyJS and GraphQL
- Share opions on the Pro/Cons of using this framework
- Offer my conclusion
- Show housekeeping
